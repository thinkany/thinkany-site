...
var NHTheme = function () {
  ...
  function init($) {
    onceInstantiatedModules = ["NHTheme", "NHHeader"];
    NHHeader.init();
    init_modules();
  }
  ...
  function init_modules() {
    ...
    Object.getOwnPropertyNames(window).forEach(function (name) {
      if (name.indexOf("NH") < 0 || onceInstantiatedModules.indexOf(name) > -1 || !window[name].hasOwnProperty("init")) {
        return;
      }
